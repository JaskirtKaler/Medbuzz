        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.scrollContainer}>
                ...
                <View style={styles.upperRow}>
                    ...
                    {/* Job Date Posted */}
                    <View style={styles.upperRowItem}>
                        <Text style={styles.upperRowItemTitleRed}>Applied On</Text>
                        <Text style={styles.upperRowItemBodyRed}>{jobApplyDate || testDate}</Text>
                    </View>
                </View>
