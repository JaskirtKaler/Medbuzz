import {
  ...
  const Homepage = () => {
    ...
    const {jobPostings = [], isLoading, fetchData} = useJobPostings(); // Ensure jobPostings is initialized as an empty array
    ...
    useEffect(() => {
      if (searchQuery.trim()) {
        ...
        setFilteredJobs(jobPostings || []); // fallback to empty array if undefined
      }
